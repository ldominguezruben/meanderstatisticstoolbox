...
%----------------------------------------------------------------------------
function [f,wave,period,scale,coi] = ...
...
%     base2 = fix(log2(n1) + 0.4999);   % power of 2 nearest to N...old
	x = [x,zeros(1,2^(base2)-n1)]; % .............Not clear
end
...
for a1 = 1:J1+1
	[daughter,fourier_factor,coi,dofmin]=wave_bases(mother,k,scale(a1),param,dt);	
...
f = f(:,1:n1);                          % redefinition of vector f to get rid of padding before returning   (FFT)
return
